...
//     float radius =
//         (attenuation.y + sqrtf(pow(attenuation.y, 2) -
//                                (4 * attenuation.z * (attenuation.x - 256)))) /
//         (2 * attenuation.z);

//     lighting_pass_shader->SetUniformMatrix4fv(
...
//     lighting_pass_shader->SetUniform3f("lightPosition",
//                                        glm::vec3(view * glm::vec4(lightPos, 1)));
...
//     composite_pass_shader->SetUniform3f(
//         "l",
//         glm::vec3(context.camera_transform.GetViewMatrix() * glm::vec4(1, 1, 1,
//         0)));
