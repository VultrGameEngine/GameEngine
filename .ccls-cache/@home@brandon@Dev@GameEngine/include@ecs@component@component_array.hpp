// Interface is used by the ComponentManager to tell a ageneric ComponentArray that an entity has been destroyed
#pragma once
...
public:
    void InsertData(Entity entity, T component)
    {
        ...
        // Create the relations between the entity ID and the new_index in the component array
    ...
    void RemoveData(Entity entity)
    {
        ...
        // Move the last element of the component array into the removed entity's index
