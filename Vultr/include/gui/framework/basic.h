    ...
    namespace GUI
    {
        ...
        class ColoredBox : public SingleChildRenderObjectWidget
        {
          private:
            ...
            {
              public:
                RenderedColoredBox(BuildContext *context, Widget *widget) : SingleChildRenderObject(widget)
                {
                }
        ...
        class SizedBox : public SingleChildRenderObjectWidget
        {
          ...
          public:
            ...
            {
              public:
                RenderSizedBox(BuildContext *context, SizedBox *widget) : SingleChildRenderObject(widget)
                {
                }
        ...
        class AnimatedSizedBox : public SingleChildRenderObjectWidget
        {
          ...
          public:
            ...
            {
              public:
                RenderAnimatedSizedBox(BuildContext *context, AnimatedSizedBox *widget) : SingleChildRenderObject(widget)
                {
                }
                ...
                Size Layout(BuildContext *context, BoxConstraints constraints, Element *child) override
                {
                    ...
                    if (layed_out)
                    {
                        size.width = Math::lerp(GetSize().width, size.width, GetConfig()->GetSpeed(), context->GetTickInfo().m_delta_time);
                        size.height = Math::lerp(GetSize().height, size.height, GetConfig()->GetSpeed(), context->GetTickInfo().m_delta_time);
                    }
                    if (child != nullptr)
                    {
                        BoxConstraints child_constraints = BoxConstraints::Tight(size);
            ...
            AnimatedSizedBox(Params params) : width(params.width), height(params.height), speed(params.speed)
            {
                key = params.key;
                child = params.child;
            }
        ...
        class Center : public SingleChildRenderObjectWidget
        {
          ...
          public:
            ...
            {
              public:
                RenderCenter(BuildContext *context, Center *widget) : SingleChildRenderObject(widget)
                {
                }
        ...
        class Align : public SingleChildRenderObjectWidget
        {
          ...
          public:
            ...
            {
              public:
                RenderAlign(BuildContext *context, Align *widget) : SingleChildRenderObject(widget)
                {
                }
                ...
                Size Layout(BuildContext *context, BoxConstraints constraints, Element *child) override
                {
                    if (child != nullptr)
                    {
                        ...
                        Size child_size = child->Layout(context, constraints.GenerateLoose());
                        if (GetConfig()->alignment.x != 0 && parent_size.width != child_size.width)
                        {
                            double difference = parent_size.width - child_size.width;
                            double padding = 0.5 * difference * GetConfig()->alignment.x;
                            position.x = padding;
                        }
                        if (GetConfig()->alignment.y != 0 && parent_size.height != child_size.height)
                        {
        ...
        class Padding : public SingleChildRenderObjectWidget
        {
          ...
          public:
            ...
            {
              public:
                RenderPaddingBox(BuildContext *context, Padding *widget) : SingleChildRenderObject(widget)
                {
                }
                ...
                Size Layout(BuildContext *context, BoxConstraints constraints, Element *child) override
                {
                    ...
                    BoxConstraints child_constraints = BoxConstraints::Loose(Size(width, height));

                    Size child_size = child->Layout(context, child_constraints);
                    return UpdateSize(Size(child_size.width + left + right, child_size.height + top + bottom));
                }
            };
        ...
        class ConstraintedBox : public SingleChildRenderObjectWidget
        {
          ...
          public:
            ...
            {
              public:
                RenderConstrainedBox(BuildContext *context, ConstraintedBox *widget) : SingleChildRenderObject(widget)
                {
                }
                ...
                Size Layout(BuildContext *context, BoxConstraints constraints, Element *child) override
                {
                    ...
                    BoxConstraints additional_constraints = constraints.GenerateConstraints(GetConfig()->GetConstraints());
        ...
        class Flex : public SingleChildRenderObjectWidget
        {
          ...
          public:
            ...
            {
              public:
                RenderFlex(BuildContext *context, Flex *widget) : SingleChildRenderObject(widget)
                {
                }
                ...
                Size Layout(BuildContext *context, BoxConstraints constraints, Element *child, bool layout) override
                {
        ...
        class Row : public MultiChildRenderObjectWidget
        {
          ...
          public:
            ...
            {
              public:
                RenderRow(BuildContext *context, Row *widget) : MultiChildRenderObject(widget)
                {
                }
                ...
                Size Layout(BuildContext *context, BoxConstraints constraints, std::vector<Element *> children) override
                {
                    double width = 0;
                    double height = 0;
                    ...
                    for (Element *child : children)
                    {
                        ...
                        Size child_size = child->GetSize(context, constraints.GenerateLoose());
                    ...
                    if (flex_total > 0)
                    {
                        ...
                        for (int i = 0; i < child_sizes.size(); i++)
                        {
                            ...
                            {
                                BoxConstraints flex_constraints = constraints.GenerateLoose();
        ...
        class Column : public MultiChildRenderObjectWidget
        {
          ...
          public:
            ...
            {
              public:
                RenderColumn(BuildContext *context, Column *widget) : MultiChildRenderObject(widget)
                {
                }
                ...
                Size Layout(BuildContext *context, BoxConstraints constraints, std::vector<Element *> children) override
                {
                    ...
                    if (flex_total > 0)
                    {
                        ...
                        for (int i = 0; i < child_sizes.size(); i++)
                        {
                            ...
                            {
                                BoxConstraints flex_constraints = constraints.GenerateLoose();
                                double flex_height = empty_height * (size.value / flex_total);
                                // These are now the tight constraints which the flex will
                                // properly layout its children with
