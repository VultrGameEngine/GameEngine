...
//   public:
//     RenderGroup(RenderGroupID p_id = 0, Zindex p_min_z = 0, Zindex p_max_z =
//     20000)
//         : id(p_id), min_z(p_min_z), max_z(p_max_z)
//     {
//         vao = new VertexArray();
//         vao->Bind();
...
//     RenderGroupID SubmitQuad(QuadID quad, Zindex z_index, Texture *texture)
//     {
//         // If there is no room for either quads or textures, we need to tell
//         whoever
//         // submitted to us that we don't have room
//         if (num_quads >= MAX_QUADS)
//         {
//             return SubmitQuadToNewDependent(quad, z_index, texture);
//         }
...
//     RenderGroupID SubmitQuadToNewDependent(QuadID quad, Zindex z_index,
//                                            Texture *texture)
//     {
//         if (z_index > z_index_groups.rbegin()->first)
//         {
//         }
//         else
//         {
...
//     {
//         // Draw all of our dependencies (basically just framebuffers that have to
//         get
//         // rendered first)
//         for (auto [id, group] : dependent_render_groups)
//         {
//             group->Draw(shader);
//         }
...
//     std::map<Zindex, RenderGroup *> dependent_render_groups;
