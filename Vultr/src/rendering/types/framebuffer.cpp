...
namespace Vultr
{
    ...
    Framebuffer new_framebuffer(u32 width, u32 height)
    {
        ...
        fbo.color_attachments = static_cast<TextureOrRBO *>(malloc(sizeof(TextureOrRBO) * fbo.max_color_attachments));
    ...
    {
        Framebuffer fbo = new_framebuffer(old_fbo.width, old_fbo.height);
