...
class ScriptScanner
{
  ...
  private:
    const std::map<std::string, TokenType> keywords = {
        {"VPROPERTY", TokenType::PROPERTY},
        {"VSYSTEM", TokenType::SYSTEM_PROP},
        {"VCOMPONENT", TokenType::COMPONENT_PROP},
        {"VSTRUCT", TokenType::STRUCT_PROP},
        {"VFUNCTION", TokenType::FUNCTION_PROP},
